...
struct Promotion: Codable {
    let promotionID, gid, title: String?
    let image: ArakGroundhog?
    let price, marketPrice, cosFee: Int?
    let url: String?
    let itemType, sales: Int?
    let extra: String?
    let favorited: Bool?
    let elasticTitle, elasticIntroduction: String?
    let elasticImg: [ArakGroundhog]?
    let label: [JSONAny]?
    let visitor: Visitor?
    let h5URL: String?
    let imgs: [ArakGroundhog]?
    let promotionSource, elasticType: Int?
    let titlePrefix: String?
    let views, clicks, rank: Int?
    let rankURL: String?
    let cosRadio: Int?
    let userShopCategories: JSONNull?

    enum CodingKeys: String, CodingKey {
        case promotionID = "promotion_id"
        case gid, title, image, price
        case marketPrice = "market_price"
        case cosFee = "cos_fee"
        case url
        case itemType = "item_type"
        case sales, extra, favorited
        case elasticTitle = "elastic_title"
        case elasticIntroduction = "elastic_introduction"
        case elasticImg = "elastic_img"
        case label, visitor
        case h5URL = "h5_url"
        case imgs
        case promotionSource = "promotion_source"
        case elasticType = "elastic_type"
        case titlePrefix = "title_prefix"
        case views, clicks, rank
        case rankURL = "rank_url"
        case cosRadio = "cos_radio"
        case userShopCategories = "user_shop_categories"
    }
}
...
extension Promotion {
    ...
    func with(
        ...
        extra: String?? = nil,
        favorited: Bool?? = nil,
        elasticTitle: String?? = nil,
        elasticIntroduction: String?? = nil,
        elasticImg: [ArakGroundhog]?? = nil,
        label: [JSONAny]?? = nil,
        visitor: Visitor?? = nil,
        h5URL: String?? = nil,
        imgs: [ArakGroundhog]?? = nil,
        promotionSource: Int?? = nil,
        elasticType: Int?? = nil,
        ...
        rankURL: String?? = nil,
        cosRadio: Int?? = nil,
        userShopCategories: JSONNull?? = nil
    ) -> Promotion {
        return Promotion(
            ...
            cosFee: cosFee ?? self.cosFee,
            url: url ?? self.url,
            itemType: itemType ?? self.itemType,
            sales: sales ?? self.sales,
            extra: extra ?? self.extra,
            favorited: favorited ?? self.favorited,
            elasticTitle: elasticTitle ?? self.elasticTitle,
            elasticIntroduction: elasticIntroduction ?? self.elasticIntroduction,
            elasticImg: elasticImg ?? self.elasticImg,
            label: label ?? self.label,
            visitor: visitor ?? self.visitor,
            h5URL: h5URL ?? self.h5URL,
            imgs: imgs ?? self.imgs,
            promotionSource: promotionSource ?? self.promotionSource,
            elasticType: elasticType ?? self.elasticType,
            titlePrefix: titlePrefix ?? self.titlePrefix,
            views: views ?? self.views,
            clicks: clicks ?? self.clicks,
            rank: rank ?? self.rank,
            rankURL: rankURL ?? self.rankURL,
            cosRadio: cosRadio ?? self.cosRadio,
            userShopCategories: userShopCategories ?? self.userShopCategories
        )
    }
...
// MARK: Visitor convenience initializers and mutators

extension Visitor {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(Visitor.self, from: data)
    }
...
struct Video: Codable {
    ...
    let bitRate: [BitRate]?
    let duration, isH265, cdnURLExpired: Int?
